...
//  Bankapp
//
//  Created by Terry Jason on 2023/6/26.
//
...
//        nameLabel.font = UIFont.preferredFont(forTextStyle: .body)
        ...
        balanceLabel.font = UIFont(name: "Bodoni 72 Oldstyle Book", size: 17)
//        balanceLabel.font = UIFont.preferredFont(forTextStyle: .body)
        ...
        let chevronImag = UIImage(systemName: "chevron.right")?.withTintColor(.label, renderingMode: .alwaysOriginal)
        chevronImageView.image = chevronImag
    ...
    private func layout() {
        NSLayoutConstraint.activate([
            ...
            trailingAnchor.constraint(equalToSystemSpacingAfter: balanceStackView.trailingAnchor, multiplier: 6),
